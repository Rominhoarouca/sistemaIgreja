...
const VisitorSchema: OpenAPIV3.SchemaObject = {
  type: 'object',
  properties: {
    id: { type: 'string', format: 'uuid' },
...
const CellSchema: OpenAPIV3.SchemaObject = {
  type: 'object',
  properties: {
    id: { type: 'string', format: 'uuid' },
...
const AttendanceSchema: OpenAPIV3.SchemaObject = {
  type: 'object',
  properties: {
    id: { type: 'string', format: 'uuid' },
...
const SpiritualHistorySchema: OpenAPIV3.SchemaObject = {
  type: 'object',
  properties: {
    id: { type: 'string', format: 'uuid' },
    visitorId: { type: 'string', format: 'uuid' },
...
const PaginatedVisitorsSchema: OpenAPIV3.SchemaObject = {
  type: 'object',
  properties: {
...
const bearerAuth: OpenAPIV3.SecuritySchemeObject = {
  ...
  bearerFormat: 'JWT',
  description:
    'Token JWT obtido via `POST /v1/auth/login`. Informe no formato: `Bearer <token>`',
};
  ...
  paths: {
    ...
    '/v1/auth/refresh': {
      post: {
        ...
        description:
          'Usa o refreshToken para emitir um novo par de tokens (token rotation).',
        requestBody: {
          required: true,
          content: {
            'application/json': {
    ...
    '/v1/visitors': {
      ...
      get: {
        ...
        description:
          'Líderes (`LIDER`) visualizam apenas seus próprios visitantes. Admins veem todos.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'search',
    ...
    '/v1/cells/nearby': {
      get: {
        ...
        description:
          'Retorna células ordenadas pela distância usando a fórmula de Haversine.',
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: 'lat',
    ...
    '/v1/attendance': {
      post: {
        ...
        description:
          'Registra ou atualiza a presença de um visitante em uma reunião (upsert por visitante + célula + data).',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    '/v1/spiritual-history': {
      post: {
        ...
        description:
          'Adiciona um marco na jornada espiritual do visitante (batismo, treinamento, liderança, etc.).',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    '/v1/dashboard/stats': {
      get: {
        ...
        description:
          'Retorna métricas consolidadas: total de visitantes, taxa de integração, células ativas, presença média.',
        security: [{ bearerAuth: [] }],
        responses: {
          '200': {
